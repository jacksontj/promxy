...
func TestSampleDelivery(t *testing.T) {
	...
	// batch timeout case.
	n := DefaultQueueConfig.Capacity * 2
...
func TestSampleDeliveryTimeout(t *testing.T) {
	...
	n := DefaultQueueConfig.Capacity - 1
...
func TestSampleDeliveryOrder(t *testing.T) {
	ts := 10
	n := DefaultQueueConfig.MaxSamplesPerSend * ts
...
func TestSpawnNotMoreThanMaxConcurrentSendsGoroutines(t *testing.T) {
	...
	n := DefaultQueueConfig.MaxSamplesPerSend * 2
	...
	if m.queueLen() != DefaultQueueConfig.MaxSamplesPerSend {
